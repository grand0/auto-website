...
<#macro content>
        ...
        $(document).ready(function () {
            $("#create-button").on("click", function () {
                ...
                if (formValid) {
                    ...
                    $.ajax({
                        url: "${contextPath}/advertisements/new",
                        type: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function (response) {
                            if (response.success) {
                                window.location.replace("${contextPath}/advertisements?id=" + response.id)
                            } else {
    ...
    <form class="container">
        <div class="row g-3">
            <div class="col-12">
                <label for="car-select" class="form-label">Car (<a href="${contextPath}/garage/new">add</a>)</label>
