                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a class="icon-link" href="${contextPath}/profile?id=${advertisement.seller.id}">
                    ...
                    <#if !isMy>
                        <div class="card-footer p-0">
                            <a class="btn btn-primary icon-link w-100 justify-content-center" href="${contextPath}/chat?ad_id=${advertisement.id}&recipient_id=${advertisement.seller.id}" style="border-radius: 0 0 0.375rem 0.375rem">
