    ...
    <div class="container">
                ...
                <div class="card mb-2">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <#if (carAdvertisementMap?keys)?seq_contains((car.id)?string)>
                            <a class="icon-link mt-2 link-info" href="${contextPath}/advertisements?id=${carAdvertisementMap[(car.id)?string]}">
                                <i class="bi bi-card-heading"></i>
                                <span>Advertising</span>
                            </a>
                        <#else>
                            <div>
                                <a class="icon-link mt-2 me-2" href="${contextPath}/advertisements/new?id=${car.id}">
                                    <i class="bi bi-card-heading"></i>
                                    <span>Advertise</span>
                                </a>
        ...
        <#else>
            <div class="d-flex flex-column align-items-center">
                ...
                <p>Try adding <a href="${contextPath}/garage/new">new car</a>.</p>
            </div>
        </#if>
    </div>
